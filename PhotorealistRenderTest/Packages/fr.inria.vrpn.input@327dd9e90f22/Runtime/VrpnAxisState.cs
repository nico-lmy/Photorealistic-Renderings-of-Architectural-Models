...
namespace Vrpn.Input
{
    ...
    public struct VrpnAxisState : IInputStateTypeInfo
    {
        #region Fields

        [InputControl(name = "axis", displayName = "Axis", layout = "Axis", dontReset = true)]
        public float axis;
        ...
        public FourCC format => new FourCC('V', 'R', 'P', 'A');
